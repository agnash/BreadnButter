...
// POSIX version - calls system() for shell command execution
...
int main() {
    ...
    while (esc == false) {
        ...
        cout << "\t6) Interesting stocks" << endl;
        cout << "\t7) Reminders" << endl;
        cout << "\t8) Exit" << endl;
        ...
        switch (selection) {
            ...
            case '5':
                ...
                break;
            case '6':
                cout << "\tPress 1 to see a list of interesting stocks or 2 to add to the list: ";
                cin >> list;
                cout << endl;
                switch (list) {
                    case '1':
                        system("bash ~/324260/scripts/see_stocks.sh");
                        break;
                    case '2':
                        system("bash ~/324260/scripts/add_stocks.sh");
                        break;
                    default:
